...
def main(args):
    ...
    best_ci = 0
    best_epoch = -1
    model_file_name = f'results_ablation/{dataset}/'  + f'train_{model_st}.model'
    result_file_name = f'results_ablation/{dataset}/' + f'train_{model_st}.csv'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type = str, default = 'HMANet', choices = ['HMANet'])
